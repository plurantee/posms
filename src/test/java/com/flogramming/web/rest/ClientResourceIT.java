...
class ClientResourceIT {
    ...
    public static Client createEntity(EntityManager em) {
        Client client = new Client().clientName(DEFAULT_CLIENT_NAME).clientCode(DEFAULT_CLIENT_CODE);
        return client;
    }
    ...
    public static Client createUpdatedEntity(EntityManager em) {
        Client client = new Client().clientName(UPDATED_CLIENT_NAME).clientCode(UPDATED_CLIENT_CODE);
        return client;
    }
    ...
    void getAllClients() throws Exception {
        ...
        restClientMockMvc
            ...
            .andExpect(jsonPath("$.[*].clientCode").value(hasItem(DEFAULT_CLIENT_CODE)));
    }
    ...
    void getClient() throws Exception {
        ...
        restClientMockMvc
            ...
            .andExpect(jsonPath("$.clientCode").value(DEFAULT_CLIENT_CODE));
    }
    ...
    void putNewClient() throws Exception {
        ...
        updatedClient.clientName(UPDATED_CLIENT_NAME).clientCode(UPDATED_CLIENT_CODE);
    ...
    void partialUpdateClientWithPatch() throws Exception {
        ...
        partialUpdatedClient.clientName(UPDATED_CLIENT_NAME).clientCode(UPDATED_CLIENT_CODE);
